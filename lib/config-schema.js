...
var truthies = [ 'true',  't', '1', 1 ];
var falsies =  [ 'false', 'f', '0', 0 ];
    ...
    switch(propSchema.type) {
      ...
      case types.enum:
        ...
        if(_.indexOf(propSchema.enumValues, val) === -1) {
          normalized.valid = false;
          normalized.reason = 'must be one of [' +
            propSchema.enumValues.join(', ') +
            ']';
        }
...
module.exports.getBlankSchema   = getBlankSchema;
